...
```
curl "https://nubesgen.com/demo.zip?iactool=TERRAFORM&region=eastus&application=APP_SERVICE.free&runtime=QUARKUS_NATIVE&database=NONE.free&gitops=true" | tar -xzvf -
```
