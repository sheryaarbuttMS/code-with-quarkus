...
```
curl "https://nubesgen.com/demo.zip?iactool=TERRAFORM&region=eastus&application=APP_SERVICE.basic&runtime=QUARKUS&database=NONE.free&gitops=true" | tar -xzvf -
```
